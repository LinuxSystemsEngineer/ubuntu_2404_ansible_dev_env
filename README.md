...
## Overview
This project automates the setup of an Ubuntu 24.04 LTS system using Ansible. It includes tasks such as installing apt packages, creating directories, configuring user environments, and more. The playbook runs the `main.yml` file then calls multiple tasks in the `./tasks` directory.
